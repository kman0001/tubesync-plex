...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/runner/work/tubesync-plex/tubesync-plex/ffmpeg-8.0/../ffmpeg/x86_64 --arch=x86_64 --target-os=linux --disable-doc --disable-ffplay --disable-network --disable-debug --enable-small --disable-programs --disable-everything --enable-decoder=subrip --enable-decoder=dvdsub --enable-decoder=hdmv_pgs --enable-demuxer=mov --enable-demuxer=matroska --enable-muxer=mp4 --enable-muxer=mkv --enable-parser=subrip
...
CFLAGS=   -std=c17 -fomit-frame-pointer -fPIC -pthread  -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz
